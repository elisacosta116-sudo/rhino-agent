# get_modeling_guidance("overview")

> Capturado do servidor (guidance_version 2, rhinomcp 0.4.1.1).
> Conteudo do proprio servidor, reproduzido literalmente.

Topicos disponiveis: `overview`, `transforms`, `planar_regions`, `organization`, `verification`, `recovery`
